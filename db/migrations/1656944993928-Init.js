module.exports = class Init1656944993928 {
  name = 'Init1656944993928'

  async up(db) {
    await db.query(`CREATE TABLE "purchase" ("id" character varying NOT NULL, "bought_with_credits" boolean NOT NULL, "amount" numeric NOT NULL, "timestamp" numeric NOT NULL, "block" integer NOT NULL, "transaction_hash" text NOT NULL, "buyer_id" character varying NOT NULL, "referrer_id" character varying, CONSTRAINT "PK_86cc2ebeb9e17fc9c0774b05f69" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "value" numeric NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
